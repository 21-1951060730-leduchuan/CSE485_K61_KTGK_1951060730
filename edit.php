            ...
            <div class="col-md-8 ms-auto me-auto">
                ...
                <form class="row g-3 needs-validation" method="post" action="" novalidate>
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="ten_donvi" id="validationCustom01" value="<?php echo isset($_POST['bd_name']) ? $_POST['bd_name'] : $BD['bd_name']?>" required>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="date" class="form-control" name="ngayhethan" id="validationCustom02" value="<?php echo isset($_POST['bd_reg_date']) ? $_POST['bd_reg_date'] : $BD['bd_reg_date']?>" required>
                    </div>
                    <div class="col-md-6">
                        <label for="validationCustom02" class="form-label">địa chỉ</label>
                        <input type="text" class="form-control" name="diachi" id="validationCustom02" value="<?php echo isset($_POST['bd_phno']) ? $_POST['bd_phno'] : $BD['bd_phno']?>" required>
                    </div>
                    <div class="col-12">
